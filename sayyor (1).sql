...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 27, 2022 at 04:17 PM
...
INSERT INTO `food_sampling_certificate` (`id`, `kod`, `inn`, `organization_id`, `sampling_site`, `sampling_adress`, `sampler_organization_code`, `sampler_person_pnfl`, `unit_id`, `count`, `verification_sample`, `producer`, `serial_num`, `manufacture_date`, `sell_by`, `coments`, `verification_pupose_id`, `sample_box_id`, `sample_condition_id`, `sampling_date`, `send_sample_date`, `explanations`, `based_public_information`, `message_number`, `laboratory_test_type_id`) VALUES
(1, '66666', NULL, 1, NULL, '', NULL, NULL, 1, '4', 1, 'влждлвпдлвдаплджвқлпждвлп', 'аврваравр', '2022-02-14', '2022-02-26', 'тететететет', 1, 1, NULL, NULL, NULL, 'ақавқавқвақвақвақ', 0, 56565, 1);
...
ALTER TABLE `food_sampling_certificate`
  ...
  ADD KEY `food_sampling_certificate_ibfk_3` (`inn`);
...
--
ALTER TABLE `food_sampling_certificate`
  ADD CONSTRAINT `FK_food_sampling_certificate_inn` FOREIGN KEY (`inn`) REFERENCES `legal_entities` (`inn`) ON DELETE NO ACTION,
